...
export function Services() {
  return (
    <section id="services" className="bg-white text-gray-800 py-24 px-2">
      ...
      <div className="container mx-auto grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {servicesData.map((service, index) => (
          <div key={index} className="flex flex-col items-center p-6 bg-gray-100/70 rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
